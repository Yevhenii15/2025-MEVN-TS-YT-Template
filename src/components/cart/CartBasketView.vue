<template>
  <transition name="fade-slide">
    ...
    >
      ...
      <div
        @click.stop
        class="cart-content bg-[#181818] w-96 h-full p-4 overflow-y-auto"
      >
        <!-- Cart content & .stop -->
        <!-- top close X -->
        <button
        ...
        <div v-for="item in cart" :item="item._id" class="mb-4">
          ...
          <div class="flex pb-2">
            ...
            <div class="flex ml-2 flex-col justify-between">
              <div>
                ...
                <!-- Product price -->
                <p>
                  Total: {{ cartTotalIndividualProduct(item._id).toFixed(2) }}
                </p>
