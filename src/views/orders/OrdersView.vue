    ...
    <div class="w-2/3">
      ...
      <div v-else>
        ...
        <div
          ...
          :key="
            orders[0]._id // Accessing the first order in the array
          "
            ...
            >
              ...
              <div class="w-1/6 text-right">
                <p class="font-semibold">
                  ...
                  {{
                    (
                      calculateDiscountedPrice(item.product) * item.quantity
                    ).toFixed(2)
                  }}
                </p>
  ...
  return orders.value
    ...
    .reduce((acc, order) => {
      const orderTotal = order.orderLine.reduce((orderAcc, item) => {
        return (
          orderAcc + calculateDiscountedPrice(item.product) * item.quantity
        );
      }, 0);
